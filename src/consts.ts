...
// ramp at the knob hue, accent families at ±60°) is derived from this —
// see src/styles/themes.css and docs/color-system.md. Changing it re-tints
// the entire site (both modes).
